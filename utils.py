...
class TimeSeriesDataset(torch.utils.data.Dataset):
    def __init__(self, data_path, mode, p_train, kmin, kmax, d, spinup, spacing, iterations, mean_data, std_data, device, transform=None):
        """
        Custom Dataset for loading QG samples lazily.
    ...
    def __getitem__(self, idx):
        ...
        y_index = x_index + self.kmin + self.d * np.arange(0, 1 + (self.kmax-self.kmin)//self.d) 
