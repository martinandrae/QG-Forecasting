...
date = '2024-08-22'  # Date of the experiment
...
res_std_geopotential500 = res_std_geopotential500[:120]
...
def train():
    ...
    model = EDMPrecond(filters=filters, img_channels=input_times*vars, out_channels=vars, img_resolution = 64, time_emb=1, 
