...
json_file = f'{data_directory}/norm_factors.json'
...
dataset_path = Path(f'{data_directory}/z500_t850_t2m_u10_v10_1979-2018_5.625deg.npy')
...
fnm_ll = f'{data_directory}/latlon_1979-2018_5.625deg.npz'
lat, lon = np.load(fnm_ll).values() 
# -----------------------------------------------------
...
def evaluate():
    ...
    val_time_series_dataset = ERA5Dataset(lead_time=k_series, dataset_mode='test', **kwargs)
